...
export default function DailySummary({ records, dateStr, coefMap }: Props) {
    ...
    return (
        <div className="flex items-center gap-3 px-2 py-1 bg-bg-surface/50 rounded-lg border border-border/50 animate-fade-in">
            {/* Label */}
            <span className="text-[10px] font-bold text-text-muted">今日の記録</span>
